    ...
    public function cancel_subscription($subscription_id, $reason = '') {
        ...
        if ($result !== false) {
            ...
            if ($subscription->license_id) {
                ...
                $license_key = get_the_title($subscription->license_id);
                $activated_domains = get_post_meta($subscription->license_id, '_wplm_activated_domains', true) ?: [];
                ...
                foreach ($activated_domains as $domain) {
                    do_action('wplm_license_deactivated_for_plugin_deactivation', $subscription->license_id, $domain, $license_key);
                }
            }
