...
<div class="wplm-customers-wrap">
    ...
    <div class="wplm-customers-toolbar">
        ...
        <div class="wplm-export-actions">
            <button type="button" class="button button-primary" id="wplm-add-new-customer">
...
<div id="wplm-add-customer-modal" class="wplm-modal" style="display: none;">
    <div class="wplm-modal-content">
        <div class="wplm-modal-header">
        ...
        <div class="wplm-modal-body">
            <form id="wplm-create-customer-form">
                <?php wp_nonce_field('wplm_create_customer_nonce', 'wplm_create_customer_nonce_field'); ?>
                <table class="form-table">
                    <tbody>
                        <tr>
                            <th><label for="add_customer_user_id"><?php _e('Link to WordPress User', 'wp-license-manager'); ?></label></th>
                            <td>
                                <select id="add_customer_user_id" name="user_id" class="wplm-ajax-search-users" style="width: 100%;" data-placeholder="<?php _e('Search for a WordPress user', 'wp-license-manager'); ?>">
                                    <option value=""></option>
                                </select>
                                <p class="description"><?php _e('Optionally link this customer to an existing WordPress user.', 'wp-license-manager'); ?></p>
                            </td>
                        </tr>
                        <tr>
                            <th><label for="add_customer_first_name"><?php _e('First Name', 'wp-license-manager'); ?></label></th>
                            <td><input type="text" id="add_customer_first_name" name="first_name" class="regular-text" required /></td>
                        </tr>
                        <tr>
                            <th><label for="add_customer_last_name"><?php _e('Last Name', 'wp-license-manager'); ?></label></th>
                            <td><input type="text" id="add_customer_last_name" name="last_name" class="regular-text" required /></td>
                        </tr>
                        <tr>
                            <th><label for="add_customer_email"><?php _e('Email', 'wp-license-manager'); ?></label></th>
                            <td><input type="email" id="add_customer_email" name="email" class="regular-text" required /></td>
                        </tr>
                        <tr>
                            <th><label for="add_customer_company"><?php _e('Company', 'wp-license-manager'); ?></label></th>
                            <td><input type="text" id="add_customer_company" name="company" class="regular-text" /></td>
                        </tr>
                        <tr>
                            <th><label for="add_customer_phone"><?php _e('Phone', 'wp-license-manager'); ?></label></th>
                            <td><input type="text" id="add_customer_phone" name="phone" class="regular-text" /></td>
                        </tr>
                        <tr>
                            <th><label for="add_customer_address"><?php _e('Address', 'wp-license-manager'); ?></label></th>
                            <td><input type="text" id="add_customer_address" name="address" class="regular-text" /></td>
                        </tr>
                        <tr>
                            <th><label for="add_customer_city"><?php _e('City', 'wp-license-manager'); ?></label></th>
                            <td><input type="text" id="add_customer_city" name="city" class="regular-text" /></td>
                        </tr>
                        <tr>
                            <th><label for="add_customer_state"><?php _e('State/Province', 'wp-license-manager'); ?></label></th>
                            <td><input type="text" id="add_customer_state" name="state" class="regular-text" /></td>
                        </tr>
                        <tr>
                            <th><label for="add_customer_zip"><?php _e('Zip/Postal Code', 'wp-license-manager'); ?></label></th>
                            <td><input type="text" id="add_customer_zip" name="zip" class="regular-text" /></td>
                        </tr>
                        <tr>
                            <th><label for="add_customer_country"><?php _e('Country', 'wp-license-manager'); ?></label></th>
                            <td><input type="text" id="add_customer_country" name="country" class="regular-text" /></td>
                        </tr>
                        <tr>
                            <th><label for="add_customer_social_media"><?php _e('Social Media Links', 'wp-license-manager'); ?></label></th>
                            <td><textarea id="add_customer_social_media" name="social_media" rows="4" class="large-text"></textarea><p class="description"><?php _e('Enter social media links, one per line.', 'wp-license-manager'); ?></p></td>
                        </tr>
                    </tbody>
                </table>
                <p class="submit">
                    <button type="submit" class="button button-primary" id="submit-add-customer"><?php _e('Add Customer', 'wp-license-manager'); ?></button>
                    <button type="button" class="button wplm-modal-cancel"><?php _e('Cancel', 'wp-license-manager'); ?></button>
                </p>
            </form>
        </div>
    </div>
